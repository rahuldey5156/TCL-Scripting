set out1 [open stacking_Hbond_backbone.dat w]

set sys [mol new protein_0ns.pdb]
mol addfile combine.xtc waitfor all

set x1 [atomselect $sys "chain A and backbone"]
set y1 [atomselect $sys "chain B and backbone"]

set x2 [atomselect $sys "chain C and backbone"]
set y2 [atomselect $sys "chain D and backbone"]

set x3 [atomselect $sys "chain E and backbone"]
