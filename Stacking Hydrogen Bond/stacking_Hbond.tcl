set out1 [open stacking_Hbond.dat w]

set sys [mol new protein_0ns.pdb]
mol addfile combine.xtc waitfor all

set x1 [atomselect $sys "chain A"]
set y1 [atomselect $sys "chain B"]

set x2 [atomselect $sys "chain C"]
set y2 [atomselect $sys "chain D"]

set x3 [atomselect $sys "chain E"]
